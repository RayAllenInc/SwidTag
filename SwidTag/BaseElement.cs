...
namespace FearTheCowboy.Iso19770 {
    ...
    public class BaseElement {
        internal static IdentityIndex IdentityIndex = new IdentityIndex();
        ...
        protected internal IEnumerable<XAttribute> AllAttributes
        {
            get
            {
        ...
        internal XElement SetAttribute(XName attribute, string value) {
